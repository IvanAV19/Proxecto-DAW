        ...
        <table class="table">
            ...
            @forelse ($technicians as $technician)
                <tr id="target{{$technician->id}}">
                    ...
                    <td>
                        <a href="{{ route('tecnicos.show', [$technician->id]) }}" class="btn btn-outline-primary"><i class="fas fa-info-circle"></i> Ver más</a>
                        <a href="{{ route('tecnicos.edit', [$technician->id]) }}" class="btn btn-outline-dark"><i class="fas fa-edit"></i> Editar</a>
                        <a href="{{ route('tecnicos.destroy', [$technician->id]) }}" class="btn btn-outline-danger" @click="getElementData" data-id={{$technician->id}} data-toggle="modal" data-target="#deleteModal"><i class="fas fa-trash"></i> Eliminar</a>
                    </td>
                </tr>
            @empty
