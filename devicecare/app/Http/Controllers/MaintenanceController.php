...
class MaintenanceController extends Controller
{
    ...
    public function postStore(CreateRequest $request)
    {
        ...
        $request->session()->flash('message', 'El tipo de mantenimiento ha sido agregado correctamente.');
    ...
    public function putUpdate(EditRequest $request, $id)
    {
        ...
        $maintenance->update($request->all()); //actualiza los datos

        $request->session()->flash('message', 'El tipo de mantenimiento ha sido actualizado correctamente.');
