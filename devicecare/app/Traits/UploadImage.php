...
trait UploadImage
{
    ...
    public function upload($file, $prefix = '', $disk = 'public')
    {
        ...
        if (!$result) {
            $this->error_message = 'Ha ocurrido un error al subir '.$file->getClientOriginalName();
            return false;
        }
    ...
    public function validateFile($file, $extension)
    {
        if ($file->getError()) {
            ...
            $this->error_message = 'Extensión inválida del archivo. Verifica '.$file->getClientOriginalName();
