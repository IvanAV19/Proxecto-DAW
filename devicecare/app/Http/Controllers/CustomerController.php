...
class CustomerController extends Controller
{
    ...
    public function store(CreateRequest $request)
    {
        ...
        $request->session()->flash('message', 'El cliente ha sido agregado correctamente.');
    ...
    public function update(EditRequest $request, $id)
    {
        ...
        $customer->update($request->all()); //actualiza los datos

        $request->session()->flash('message', 'El cliente ha sido actualizado correctamente.');
